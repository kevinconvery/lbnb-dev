$(() => {
  ...
  // Used to clear out the reviews before the property reviews render.
  ...
  // Adds the reviews for each property
  // Used in the Add Reviews for Reservation functionality
  function addReviews(reviews) {
    clearReviews();
    $propertyReviews.append(`<h3>Reviews for ${reviews[0].property_title}</h3>`);
    // uses a map function to display the reviews
